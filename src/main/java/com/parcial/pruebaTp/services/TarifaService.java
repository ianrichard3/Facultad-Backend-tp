...
public class TarifaService {
    ...
    public Tarifa findByDiaMesYMesPromocional(int diaMes, int nroMes) {
        ...
        // List<Tarifa> filtradas = tarifas.stream().filter(
        //     tarifa ->  tarifa.getDiaMes() == diaMes && tarifa.getMes() == nroMes
        //     ).toList();
    ...
    public Tarifa findByDiaSemana(int diaSemana) {
        ...
        // List<Tarifa> filtradas = tarifas.stream().filter(
        //     tarifa ->  tarifa.getDiaSemana() == diaSemana
        //     ).toList();
    ...
    public TarifaDto getTarifaPorDiaYMes(int diaMes, int nroMes, int diaDeSemana){
        ...
        // Optional<Tarifa> optionalTarifa = tarifaRepository.findByDiaMesAndMes(diaMes, nroMes);
        

        // if (optionalTarifa.isEmpty()) {
        //     optionalTarifa = tarifaRepository.findByDiaSemana(diaDeSemana);
        // }
        

        // return optionalTarifa.map(this::convertToDto).orElse(null);
